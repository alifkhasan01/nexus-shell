...
// Tab Baterai di Dashboard — status baterai lengkap + kontrol power profile.
...
// Content dipindah dari panels/BatteryPanel.qml (PanelWindow → tab).

Item {
    id: root

    // Profile dibaca setiap tab aktif
    ...
    Rectangle {
        ...
        // Blokir klik yang menembus ke luar
