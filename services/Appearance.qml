...
Singleton {
    ...
    property real wallpaperVibrancy: wallColorQuant.colors.length > 0
        ? (wallColorQuant.colors[0]?.hslSaturation + wallColorQuant.colors[0]?.hslLightness) / 2
        : 0.5
    ...
    // ── Bridge dengan Colors.qml (Ayu palette) ──────────────────────────────
    // m3colors sekarang disinkronkan dengan Colors.currentTheme dan map dari Ayu
    m3colors: QtObject {
        property bool darkmode: Colors.isDark
        property bool transparent: false
        
        // Background & Surface — map dari Ayu base → mantle → surface*
        property color m3background: Colors.base
        property color m3onBackground: Colors.text
        property color m3surface: Colors.base
        property color m3surfaceDim: Colors.mantle
        property color m3surfaceBright: Colors.surface2
        property color m3surfaceContainerLowest: Colors.mantle
        property color m3surfaceContainerLow: Colors.surface0
        property color m3surfaceContainer: Colors.surface0
        property color m3surfaceContainerHigh: Colors.surface1
        property color m3surfaceContainerHighest: Colors.surface2
        property color m3onSurface: Colors.text
        property color m3surfaceVariant: Colors.surface1
        property color m3onSurfaceVariant: Colors.subtext
        
        // Inverse
        property color m3inverseSurface: darkmode ? Colors._latte.base : Colors._mocha.base
        property color m3inverseOnSurface: darkmode ? Colors._latte.text : Colors._mocha.text
        
        // Outline
        property color m3outline: Colors.overlay1
        property color m3outlineVariant: Colors.overlay0
        
        // Shadow & Scrim
        property color m3shadow: darkmode ? "#000000" : "#575f66"
        property color m3scrim: darkmode ? "#000000" : "#575f66"
        
        // Primary (lavender/purple accent)
        property color m3surfaceTint: Colors.lavender
        property color m3primary: Colors.lavender
        property color m3onPrimary: Colors.base
        property color m3primaryContainer: ColorUtils.mix(Colors.lavender, Colors.surface0, 0.3)
        property color m3onPrimaryContainer: Colors.text
        property color m3inversePrimary: darkmode ? Colors._latte.lavender : Colors._mocha.lavender
        
        // Secondary (blue accent)
        property color m3secondary: Colors.blue
        property color m3onSecondary: Colors.base
        property color m3secondaryContainer: ColorUtils.mix(Colors.blue, Colors.surface0, 0.3)
        property color m3onSecondaryContainer: Colors.text
        
        // Tertiary (mauve accent)
        property color m3tertiary: Colors.mauve
        property color m3onTertiary: Colors.base
        property color m3tertiaryContainer: ColorUtils.mix(Colors.mauve, Colors.surface0, 0.3)
        property color m3onTertiaryContainer: Colors.text
        
        // Error (red)
        property color m3error: Colors.red
        property color m3onError: Colors.base
        property color m3errorContainer: ColorUtils.mix(Colors.red, Colors.surface0, 0.3)
        property color m3onErrorContainer: Colors.text
        
        // Fixed variants (untuk toggle states)
        property color m3primaryFixed: ColorUtils.mix(Colors.lavender, Colors.text, darkmode ? 0.7 : 0.3)
        property color m3primaryFixedDim: Colors.lavender
        property color m3onPrimaryFixed: Colors.base
        property color m3onPrimaryFixedVariant: Colors.surface2
        
        property color m3secondaryFixed: ColorUtils.mix(Colors.blue, Colors.text, darkmode ? 0.7 : 0.3)
        property color m3secondaryFixedDim: Colors.blue
        property color m3onSecondaryFixed: Colors.base
        property color m3onSecondaryFixedVariant: Colors.surface2
        
        property color m3tertiaryFixed: ColorUtils.mix(Colors.mauve, Colors.text, darkmode ? 0.7 : 0.3)
        property color m3tertiaryFixedDim: Colors.mauve
        property color m3onTertiaryFixed: Colors.base
        property color m3onTertiaryFixedVariant: Colors.surface2
        
        // Success (green)
        property color m3success: Colors.green
        property color m3onSuccess: Colors.base
        property color m3successContainer: ColorUtils.mix(Colors.green, Colors.surface0, 0.3)
        property color m3onSuccessContainer: Colors.text
        
        // Terminal colors — map dari Ayu palette
        property color term0: Colors.text         // white
        property color term1: Colors.red          // red
        property color term2: Colors.peach        // orange/peach
        property color term3: Colors.yellow       // yellow
        property color term4: Colors.green        // green
        property color term5: Colors.blue         // blue
        property color term6: Colors.lavender     // purple/lavender
        property color term7: Colors.surface2     // light gray
        property color term8: Colors.overlay0     // dark gray
        property color term9: Colors.red          // bright red
        property color term10: Colors.peach       // bright orange
        property color term11: Colors.yellow      // bright yellow
        property color term12: Colors.green       // bright green
        property color term13: Colors.blue        // bright blue
        property color term14: Colors.lavender    // bright purple
        property color term15: Colors.subtext     // bright white
    }
